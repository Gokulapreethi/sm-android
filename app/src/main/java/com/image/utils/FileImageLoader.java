    ...
    class PhotosLoader implements Runnable {
        ...
        public void run() {
            try {
                ...
                Log.d("IMAGE_LOAD", "FilePath :1 : " + photoToLoad.filename);
                String path = photoToLoad.filename;
                if (!path.endsWith(".jpg") && !path.endsWith(".png")) {
                    ...
                    if(bmp == null) {
                        try {
                            path = AESFileCrypto.decryptFile(SingleInstance.mainContext, photoToLoad.filename);
                            bmp = getBitmap(path);
                        } catch (Exception e) {
                            e.printStackTrace();
                            bmp = getBitmap(photoToLoad.filename);
                ...
                Log.d("IMAGE_LOAD", "FilePath :2 : " + photoToLoad.filename);
                ...
                Log.d("IMAGE_LOAD", "FilePath :3 : " + photoToLoad.filename);
