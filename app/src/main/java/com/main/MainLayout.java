    ...
    */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        try {
			...
			Log.d("button", "getHeight " + this.getHeight() + " getWidth " + this.getWidth());
    ...
    public void toggleMenu() {
        try {
			...
			{
			    return;}
			else if(SingleInstance.nameSatatus){
				currentMenuState=MenuState.SHOWING;
				SingleInstance.nameSatatus=false;
			}
    ...
    private void onMenuSlidingComplete() {
        try {
			switch (currentMenuState) {
			case SHOWING:
//				SingleInstance.mainContext.tv_namestatus.setEnabled(true);
    ...
    public boolean onContentTouch(View v, MotionEvent event) {
        try {
			...
			case MotionEvent.ACTION_MOVE:
				Log.i("menuslide","Actionmove");
//				SingleInstance.mainContext.tv_namestatus.setEnabled(false);
			    if(!isDragging) {
			        isDragging = true;
			        menu.setVisibility(View.VISIBLE);
			    }
			...
			case MotionEvent.ACTION_UP:
			    ...
			    Log.d("MainLayout.java", "Up lastDiffX " + lastDiffX);
