...
/**
 * Quick action Popup window, shows action list as icon and text.
 * 
 */
public class QuickAction1 extends PopupWindows1 {
	 ...
	 *            {@link ActionItem1}
	 */
	public void addActionItem(ActionItem1 action) {

		String title = action.getTitle();
		Drawable icon = action.getIcon();

		View container = (View) inflater.inflate(R.layout.action_item1, null);
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				v.setDrawingCacheBackgroundColor(R.color.transparent);
	...
	public void UpdateTextView(int pos, String Str) {
		View v = mTrack.getChildAt(pos);
