...
public class FloatingIncomingImage extends ImageView implements OnTouchListener {
	 ...
	 * @param context
	 */
	public FloatingIncomingImage(Context context) {
		super(context);
		this.ctx = context;
		this.setOnTouchListener(this); // setting touchListener to the imageView
		this.setImageResource(R.drawable.min_in_call); // setting icon to the imageView
	 ...
	 * @param attrs
	 */
	public FloatingIncomingImage(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param defStyle
	 */
	public FloatingIncomingImage(Context context, AttributeSet attrs, int defStyle) {
