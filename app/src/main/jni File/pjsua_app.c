...
const char* const kInterfacePath = "com/base/android/pjsua/pjsua";
...
static void default_config(struct app_config *cfg) {
	...
	// v*********** i have commened to assign random port for UDP .
...
/* Parse arguments. */
static pj_status_t parse_args(int argc, char *argv[], struct app_config *cfg,
	...
	struct pj_getopt_option long_options[] = { { "config-file", 1, 0,
			OPT_CONFIG_FILE }, { "log-file", 1, 0, OPT_LOG_FILE }, {
			"log-level", 1, 0, OPT_LOG_LEVEL }, { "app-log-level", 1, 0,
			OPT_APP_LOG_LEVEL }, { "log-append", 0, 0, OPT_LOG_APPEND }, {
			"color", 0, 0, OPT_COLOR }, { "no-color", 0, 0, OPT_NO_COLOR }, {
			"light-bg", 0, 0, OPT_LIGHT_BG },
			{ "no-stderr", 0, 0, OPT_NO_STDERR }, { "help", 0, 0, OPT_HELP }, {
					"version", 0, 0, OPT_VERSION }, { "clock-rate", 1, 0,
					OPT_CLOCK_RATE }, { "snd-clock-rate", 1, 0,
					OPT_SND_CLOCK_RATE }, { "stereo", 0, 0, OPT_STEREO }, {
					"null-audio", 0, 0, OPT_NULL_AUDIO }, { "local-port", 1, 0,
					OPT_LOCAL_PORT }, { "ip-addr", 1, 0, OPT_IP_ADDR }, {
					"bound-addr", 1, 0, OPT_BOUND_ADDR }, { "no-tcp", 0, 0,
					OPT_NO_TCP }, { "no-udp", 0, 0, OPT_NO_UDP }, {
					"norefersub", 0, 0, OPT_NOREFERSUB }, { "proxy", 1, 0,
					OPT_PROXY }, { "outbound", 1, 0, OPT_OUTBOUND_PROXY }, {
					"registrar", 1, 0, OPT_REGISTRAR }, { "reg-timeout", 1, 0,
					OPT_REG_TIMEOUT }, { "publish", 0, 0, OPT_PUBLISH }, {
					"mwi", 0, 0, OPT_MWI }, { "use-100rel", 0, 0, OPT_100REL },
			{ "use-ims", 0, 0, OPT_USE_IMS }, { "id", 1, 0, OPT_ID }, {
					"contact", 1, 0, OPT_CONTACT }, { "contact-params", 1, 0,
					OPT_CONTACT_PARAMS }, { "contact-uri-params", 1, 0,
					OPT_CONTACT_URI_PARAMS }, { "auto-update-nat", 1, 0,
					OPT_AUTO_UPDATE_NAT }, { "use-compact-form", 0, 0,
					OPT_USE_COMPACT_FORM }, { "accept-redirect", 1, 0,
					OPT_ACCEPT_REDIRECT }, { "no-force-lr", 0, 0,
					OPT_NO_FORCE_LR }, { "realm", 1, 0, OPT_REALM }, {
					"username", 1, 0, OPT_USERNAME }, { "password", 1, 0,
					OPT_PASSWORD }, { "rereg-delay", 1, 0,
					OPT_REG_RETRY_INTERVAL }, { "reg-use-proxy", 1, 0,
					OPT_REG_USE_PROXY }, { "nameserver", 1, 0, OPT_NAMESERVER },
			{ "stun-srv", 1, 0, OPT_STUN_SRV }, { "add-buddy", 1, 0,
					OPT_ADD_BUDDY }, { "offer-x-ms-msg", 0, 0,
					OPT_OFFER_X_MS_MSG },
			{ "no-presence", 0, 0, OPT_NO_PRESENCE }, { "auto-answer", 1, 0,
					OPT_AUTO_ANSWER }, { "auto-play", 0, 0, OPT_AUTO_PLAY }, {
					"auto-play-hangup", 0, 0, OPT_AUTO_PLAY_HANGUP }, {
					"auto-rec", 0, 0, OPT_AUTO_REC }, { "auto-loop", 0, 0,
					OPT_AUTO_LOOP }, { "auto-conf", 0, 0, OPT_AUTO_CONF }, {
					"play-file", 1, 0, OPT_PLAY_FILE }, { "play-tone", 1, 0,
					OPT_PLAY_TONE }, { "rec-file", 1, 0, OPT_REC_FILE }, {
					"rtp-port", 1, 0, OPT_RTP_PORT },

			{ "use-ice", 0, 0, OPT_USE_ICE }, { "ice-regular", 0, 0,
					OPT_ICE_REGULAR }, { "use-turn", 0, 0, OPT_USE_TURN }, {
					"ice-max-hosts", 1, 0, OPT_ICE_MAX_HOSTS }, { "ice-no-rtcp",
					0, 0, OPT_ICE_NO_RTCP }, { "turn-srv", 1, 0, OPT_TURN_SRV },
			{ "turn-tcp", 0, 0, OPT_TURN_TCP }, { "turn-user", 1, 0,
					OPT_TURN_USER }, { "turn-passwd", 1, 0, OPT_TURN_PASSWD },

#if defined(PJMEDIA_HAS_SRTP) && (PJMEDIA_HAS_SRTP != 0)
			{	"use-srtp", 1, 0, OPT_USE_SRTP},
			{	"srtp-secure",1, 0, OPT_SRTP_SECURE},
#endif
			{ "add-codec", 1, 0, OPT_ADD_CODEC }, { "dis-codec", 1, 0,
					OPT_DIS_CODEC }, { "complexity", 1, 0, OPT_COMPLEXITY }, {
					"quality", 1, 0, OPT_QUALITY },
			{ "ptime", 1, 0, OPT_PTIME }, { "no-vad", 0, 0, OPT_NO_VAD }, {
					"ec-tail", 1, 0, OPT_EC_TAIL },
			{ "ec-opt", 1, 0, OPT_EC_OPT },
			{ "ilbc-mode", 1, 0, OPT_ILBC_MODE }, { "rx-drop-pct", 1, 0,
					OPT_RX_DROP_PCT }, { "tx-drop-pct", 1, 0, OPT_TX_DROP_PCT },
			{ "next-account", 0, 0, OPT_NEXT_ACCOUNT }, { "next-cred", 0, 0,
					OPT_NEXT_CRED }, { "max-calls", 1, 0, OPT_MAX_CALLS }, {
					"duration", 1, 0, OPT_DURATION }, { "thread-cnt", 1, 0,
					OPT_THREAD_CNT },
#if defined(PJSIP_HAS_TLS_TRANSPORT) && (PJSIP_HAS_TLS_TRANSPORT != 0)
			{	"use-tls", 1, 0, OPT_USE_TLS},
...
#endif
			{ "capture-dev", 1, 0, OPT_CAPTURE_DEV }, { "playback-dev", 1, 0,
					OPT_PLAYBACK_DEV },
			{ "capture-lat", 1, 0, OPT_CAPTURE_LAT }, { "playback-lat", 1, 0,
					OPT_PLAYBACK_LAT }, { "stdout-refresh", 1, 0,
					OPT_STDOUT_REFRESH }, { "stdout-refresh-text", 1, 0,
					OPT_STDOUT_REFRESH_TEXT },
#ifdef _IONBF
			{	"stdout-no-buf", 0, 0, OPT_STDOUT_NO_BUF},
#endif
			{ "snd-auto-close", 1, 0, OPT_SND_AUTO_CLOSE }, { "no-tones", 0, 0,
					OPT_NO_TONES }, { "jb-max-size", 1, 0, OPT_JB_MAX_SIZE },
#if defined(PJ_HAS_IPV6) && PJ_HAS_IPV6
			{	"ipv6", 0, 0, OPT_IPV6},
#endif
			{ "set-qos", 0, 0, OPT_QOS }, { "use-timer", 1, 0, OPT_TIMER }, {
					"timer-se", 1, 0, OPT_TIMER_SE }, { "timer-min-se", 1, 0,
					OPT_TIMER_MIN_SE }, { "outb-rid", 1, 0, OPT_OUTB_RID }, {
					"video", 0, 0, OPT_VIDEO }, { "extra-audio", 0, 0,
					OPT_EXTRA_AUDIO },
			{ "vcapture-dev", 1, 0, OPT_VCAPTURE_DEV }, { "vrender-dev", 1, 0,
					OPT_VRENDER_DEV }, { "play-avi", 1, 0, OPT_PLAY_AVI }, {
	...
	while ((c = pj_getopt_long(argc, argv, "", long_options, &option_index))
		...
		case OPT_LOG_LEVEL:
			...
			if (c < 0 || c > 6) {
				PJ_LOG(1, (THIS_FILE, "Error: expecting integer value 0-6 "
						"for --log-level"));
				return PJ_EINVAL;
			}
			cfg->log_cfg.level = c;
		...
		case OPT_APP_LOG_LEVEL:
			...
			if (cfg->log_cfg.console_level < 0
					|| cfg->log_cfg.console_level > 6) {
				PJ_LOG(1, (THIS_FILE, "Error: expecting integer value 0-6 "
						"for --app-log-level"));
				return PJ_EINVAL;
			}
		...
		case OPT_LOCAL_PORT: /* local-port */
			...
			if (lval < 0 || lval > 65535) {
				PJ_LOG(1, (THIS_FILE, "Error: expecting integer value for "
						"--local-port"));
				return PJ_EINVAL;
			}
		...
		case OPT_REG_TIMEOUT: /* reg-timeout */
			...
			if (cur_acc->reg_timeout < 1 || cur_acc->reg_timeout > 3600) {
				PJ_LOG(1, (THIS_FILE, "Error: invalid value for --reg-timeout "
						"(expecting 1-3600)"));
				return PJ_EINVAL;
			}
			break;
		...
		case OPT_TIMER_SE: /** session timer session expiration */
			cur_acc->timer_setting.sess_expires = pj_strtoul(
					pj_cstr(&tmp, pj_optarg));
			if (cur_acc->timer_setting.sess_expires < 90) {
				PJ_LOG(1, (THIS_FILE, "Error: invalid value for --timer-se "
		...
		case OPT_TIMER_MIN_SE: /** session timer minimum session expiration */
			cur_acc->timer_setting.min_se = pj_strtoul(
					pj_cstr(&tmp, pj_optarg));
			if (cur_acc->timer_setting.min_se < 90) {
				PJ_LOG(1, (THIS_FILE, "Error: invalid value for --timer-min-se "
						"(expecting higher than 90)"));
				return PJ_EINVAL;
			}
		...
		case OPT_AUTO_UPDATE_NAT: /* OPT_AUTO_UPDATE_NAT */
			cur_acc->allow_contact_rewrite = pj_strtoul(
					pj_cstr(&tmp, pj_optarg));
			break;
		...
		case OPT_NAMESERVER: /* nameserver */
			cfg->cfg.nameserver[cfg->cfg.nameserver_count++] = pj_str(
					pj_optarg);
			if (cfg->cfg.nameserver_count
					> PJ_ARRAY_SIZE(cfg->cfg.nameserver)) {
...
//		    puts("Expecting f1,f2,on,off in --play-tone");
		...
		case OPT_TURN_USER:
			...
			cfg->media_cfg.turn_auth_cred.data.static_cred.username = pj_str(
					pj_optarg);
			break;
		...
		case OPT_TURN_PASSWD:
			...
			cfg->media_cfg.turn_auth_cred.data.static_cred.data = pj_str(
					pj_optarg);
			break;
		...
		case OPT_RTP_PORT:
			...
			if (cfg->rtp_cfg.port < 1 || cfg->rtp_cfg.port > 65535) {
				PJ_LOG(1, (THIS_FILE, "Error: rtp-port argument value "
						"(expecting 1-65535"));
				return -1;
			}
			break;
		...
		case OPT_AUTO_ANSWER:
			...
			if (cfg->auto_answer < 100 || cfg->auto_answer > 699) {
				PJ_LOG(1, (THIS_FILE, "Error: invalid code in --auto-answer "
						"(expecting 100-699"));
				return -1;
			}
			break;
		...
		case OPT_MAX_CALLS:
			...
			if (cfg->cfg.max_calls < 1
					|| cfg->cfg.max_calls > PJSUA_MAX_CALLS) {
				PJ_LOG(1,
						(THIS_FILE, "Error: maximum call setting exceeds "
								"compile time limit (PJSUA_MAX_CALLS=%d)", PJSUA_MAX_CALLS));
				return -1;
			}
			break;
		...
		default:
			PJ_LOG(1,
					(THIS_FILE, "Argument \"%s\" is not valid. Use --help to see help", argv[pj_optind
							- 1]));
			return -1;
		}
	}
	...
	for (i = 0; i < cfg->acc_cnt; ++i) {
		...
		if (acfg->auth_pref.initial_auth && acfg->cred_count) {
			...
			if (strchr(acfg->cred_info[0].username.ptr, '@') == 0) {
				PJ_LOG(1, (THIS_FILE, "Error: Username for authentication must "
 ...
 * Write settings.
 */
static int write_settings(const struct app_config *config, char *buf,
		pj_size_t max) {
	unsigned acc_index;
	unsigned i;
	pj_str_t cfg;
...
static void call_timeout_callback(pj_timer_heap_t *timer_heap,
	...
	PJ_LOG(3,
			(THIS_FILE, "Duration (%d seconds) has been exceeded "
...
static void registerAccount() {
	...
	acc_cfg.id = pj_str("sip:1007@172.16.2.16");
	acc_cfg.reg_uri = pj_str("sip:172.16.2.16");
	acc_cfg.cred_count = 1;
	acc_cfg.cred_info[0].scheme = pj_str("Digest");
	acc_cfg.cred_info[0].realm = pj_str("172.16.2.16");
	acc_cfg.cred_info[0].username = pj_str("1007");
	acc_cfg.cred_info[0].data_type = 0;
	acc_cfg.cred_info[0].data = pj_str("1234");

	acc_cfg.rtp_cfg = app_config.rtp_cfg;
	pjsua_acc_id regid;
	status = pjsua_acc_add(&acc_cfg, PJ_TRUE, &regid);
	printf("reg status %d", status);
...
static void on_call_state(pjsua_call_id call_id, pjsip_event *e) {
	...
	char *remote_info_ptr2 = (char *) call_info.remote_info.ptr;
	char *call_sessionid_ptr2 = (char *) call_info.call_id.ptr;
	...
	jstring remoteinfo2 = (*env)->NewStringUTF(env, remote_info_ptr2);
	jstring call_sessionid2 = (*env)->NewStringUTF(env, call_sessionid_ptr2);
	...
	jmethodID method = (*env)->GetMethodID(env, interfaceClass,
			"didReceiveOnCallState",
	...
	(*env)->CallVoidMethod(env, gInterfaceObject, method, remoteinfo2,
			call_sessionid2, (jint) call_id, (jint) call_info.last_status,
			(jint) call_info.state);
	if (isAttached)
		(*gJavaVM)->DetachCurrentThread(gJavaVM);
...
//        }
//        /* Find the callBack method ID */
//        jmethodID method = (*env)->GetMethodID(env,interfaceClass, "didReceiveCallDisconnected", "(Ljava/lang/String;Ljava/lang/String;II)V");
//        if(!method) {
//            if(isAttached) (*gJavaVM)->DetachCurrentThread(gJavaVM);
//            return;
//        }
//        (*env)->CallVoidMethod(env,gInterfaceObject, method,remoteinfo2,call_sessionid2,(jint)call_id,(jint)call_info.last_status);
//        if(isAttached) (*gJavaVM)->DetachCurrentThread(gJavaVM);
...
//        }
//        /* Find the callBack method ID */
//        jmethodID method = (*env)->GetMethodID(env,interfaceClass, "didReceiveCallConnected", "(Ljava/lang/String;Ljava/lang/String;I)V");
//        if(!method) {
//            if(isAttached) (*gJavaVM)->DetachCurrentThread(gJavaVM);
//            return;
//        }
//        (*env)->CallVoidMethod(env,gInterfaceObject, method,remoteinfo2,call_sessionid2,(jint)call_info.id);
//        if(isAttached) (*gJavaVM)->DetachCurrentThread(gJavaVM);
...
//        if (call_info.last_status==183 ||call_info.last_status==180)
//        {
//            int status;
//            JNIEnv *env;
//            bool isAttached = false;
...
//            }
//            /* Find the callBack method ID */
//            jmethodID method = (*env)->GetMethodID(env,interfaceClass, "didReceiveOnCallState", "(Ljava/lang/String;Ljava/lang/String;II)V");
//            if(!method) {
//                if(isAttached) (*gJavaVM)->DetachCurrentThread(gJavaVM);
//                return;
//            }
...
static void on_incoming_call(pjsua_acc_id acc_id, pjsua_call_id call_id,
	...
	const pj_str_t name = pj_str("Referred-By");
	pjsip_generic_string_hdr *referHeader =
			(pjsip_generic_string_hdr*) pjsip_msg_find_hdr_by_name(
					rdata->msg_info.msg, &name, NULL);

	printf("incoming call from %s", call_info.remote_info.ptr);

	if (referHeader != NULL) {
		__android_log_print(ANDROID_LOG_INFO, "droid123",
				"\n ...............refer header came...............");
	}
	if (referHeader == NULL) {
		pjsua_call_answer(call_id, 180, NULL, NULL);

		char *remote_info_ptr = (char *) call_info.remote_info.ptr;
		int status;
		JNIEnv *env;
		bool isAttached = false;
...
//                 "current thread");
		...
		jstring remoteinfo = (*env)->NewStringUTF(env, remote_info_ptr);
...
//        LOGE("callback_handler: failed to get class reference");
		...
		/* Find the callBack method ID */
		jmethodID method = (*env)->GetMethodID(env, interfaceClass,
				"on_incoming_call", "(ILjava/lang/String;)V");
		if (!method) {
//        LOGE("callback_handler: failed to get method ID");
		...
		(*env)->CallVoidMethod(env, gInterfaceObject, method, (jint) call_id,
				remoteinfo);
		if (isAttached)
			(*gJavaVM)->DetachCurrentThread(gJavaVM);
	} else {
...
//        LOGE("callback_handler: failed to get class reference");
		...
		/* Find the callBack method ID */
		jmethodID method = (*env)->GetMethodID(env, interfaceClass,
				"on_refermessagereceived", "(ILjava/lang/String;)V");
		if (!method) {
//        LOGE("callback_handler: failed to get method ID");
			if (isAttached)
				(*gJavaVM)->DetachCurrentThread(gJavaVM);
...
static void on_call_tsx_state(pjsua_call_id call_id, pjsip_transaction *tsx,
	...
	if (pjsip_method_cmp(&tsx->method, &info_method) == 0) {
		...
		if (body && body->len
				...
				&& pj_stricmp(&body->content_type.subtype, &STR_DTMF_RELAY)
						== 0) {
			dtmf_info = PJ_TRUE;
		}
		...
		if (dtmf_info && tsx->role == PJSIP_ROLE_UAC
			...
			if (tsx->status_code >= 200 && tsx->status_code < 300) {
				PJ_LOG(4,
						(THIS_FILE, "Call %d: DTMF sent successfully with INFO", call_id));
			} else if (tsx->status_code >= 300) {
				PJ_LOG(4,
						(THIS_FILE, "Call %d: Failed to send DTMF with INFO: %d/%.*s", call_id, tsx->status_code, (int) tsx->status_text.slen, tsx->status_text.ptr));
			}
			...
			if (rdata->msg_info.msg->body) {
				...
				PJ_LOG(3,
						(THIS_FILE, "Call %d: incoming INFO:\n%.*s", call_id, (int) rdata->msg_info.msg->body->len, rdata->msg_info.msg->body->data));
			} else {
...
static void on_call_generic_media_state(pjsua_call_info *ci, unsigned mi,
	...
	PJ_LOG(4,
			(THIS_FILE, "Call %d media %d [type=%s], status is %s", ci->id, mi, pjmedia_type_name(
...
static void on_call_audio_state(pjsua_call_info *ci, unsigned mi,
	...
	if (ci->media[mi].status == PJSUA_CALL_MEDIA_ACTIVE
		...
		if (app_config.avi_auto_play
				...
				&& app_config.avi[app_config.avi_def_idx].slot
						!= PJSUA_INVALID_ID) {
...
//      (*m_vm)->GetEnv(vm, (void**) &env, JNI_VERSION_1_4);
	...
	/* Find the callBack method ID */
	jmethodID method = (*env)->GetMethodID(env, interfaceClass, "on_call_media",
			"(I)V");
	if (!method) {
		if (isAttached)
			(*gJavaVM)->DetachCurrentThread(gJavaVM);
...
pjsip_transport *the_trasport;
static void on_reg_state2(pjsua_acc_id acc_id, pjsua_reg_info *info1) {

	pjsua_acc_info info;

	pjsua_acc_get_info(acc_id, &info);
//    __android_log_print(ANDROID_LOG_INFO,"droid123","on_reg_state2--->processAccountStatus ++++++++++++++++++++++print_acc_status has reg %d exprires %d reg statustxt- %s reason %d  last status %d",info.has_registration,info.expires,info.status_text.ptr,(int)info.status,info.reg_last_err);

	bool isStatus = false;

	bool isupdate = isAdd_reg;

	int errorCode = info.status;

	char *errorReson = (char *) info.status_text.ptr;

	struct pjsip_regc_cbparam *rp = info1->cbparam;
	...
	case 200:
		if (info.has_registration) {
			...
			if (the_trasport) {
				...
				pjsip_transport_dec_ref(the_trasport);
				the_trasport = NULL;
			}
			the_trasport = rp->rdata->tp_info.transport;
			pjsip_transport_add_ref(the_trasport);
		}
		break;
	case 503:
...
//      (*m_vm)->GetEnv(vm, (void**) &env, JNI_VERSION_1_4);
	...
	jstring errorReson_Str = (*env)->NewStringUTF(env, errorReson);
	...
	/* Find the callBack method ID */
	jmethodID method = (*env)->GetMethodID(env, interfaceClass,
			"notifyRegistration", "(IZZILjava/lang/String;)V");
	if (!method) {
		if (isAttached)
			(*gJavaVM)->DetachCurrentThread(gJavaVM);
		return;
	}
	(*env)->CallVoidMethod(env, gInterfaceObject, method, (jint) acc_id,
			(jboolean) isStatus, (jboolean) isupdate, (jint) errorCode,
			errorReson_Str);
	if (isAttached)
		(*gJavaVM)->DetachCurrentThread(gJavaVM);
...
static void on_buddy_state(pjsua_buddy_id buddy_id) {
	...
	PJ_LOG(3,
			(THIS_FILE, "%.*s status is %.*s, subscription state is %s "
					"(last termination reason code=%d %.*s)", (int) info.uri.slen, info.uri.ptr, (int) info.status_text.slen, info.status_text.ptr, info.sub_state_name, info.sub_term_code, (int) info.sub_term_reason.slen, info.sub_term_reason.ptr));
}
...
static void on_buddy_evsub_state(pjsua_buddy_id buddy_id, pjsip_evsub *sub,
	...
	PJ_LOG(4,
			(THIS_FILE, "Buddy %d: subscription state: %s (event: %s%s)", buddy_id, pjsip_evsub_get_state_name(
					sub), pjsip_event_str(event->type), event_info));
...
//      (*m_vm)->GetEnv(vm, (void**) &env, JNI_VERSION_1_4);
	...
	jstring text_Str = (*env)->NewStringUTF(env, pj_strbuf(text));
	jstring from_Str = (*env)->NewStringUTF(env, pj_strbuf(from));
	jstring to_Str = (*env)->NewStringUTF(env, pj_strbuf(to));
	jstring contact_Str = (*env)->NewStringUTF(env, pj_strbuf(contact));
	jstring mimetype_Str = (*env)->NewStringUTF(env, pj_strbuf(mime_type));
	...
	/* Find the callBack method ID */
	jmethodID method =
			(*env)->GetMethodID(env, interfaceClass, "on_pager",
	...
	(*env)->CallVoidMethod(env, gInterfaceObject, method, (jint) call_id,
			from_Str, to_Str, contact_Str, mimetype_Str, text_Str);
	if (isAttached)
		(*gJavaVM)->DetachCurrentThread(gJavaVM);
...
static void on_typing(pjsua_call_id call_id, const pj_str_t *from,
	...
	PJ_LOG(3,
			(THIS_FILE, "IM indication: %.*s %s", (int) from->slen, from->ptr, (
...
static void on_call_transfer_status(pjsua_call_id call_id, int status_code,
		const pj_str_t *status_text, pj_bool_t final, pj_bool_t *p_cont) {
	PJ_LOG(3,
			(THIS_FILE, "Call %d: transfer status=%d (%.*s) %s", call_id, status_code, (int) status_text->slen, status_text->ptr, (
					final ? "[final]" : "")));

	if (status_code / 100 == 2) {
		PJ_LOG(3,
				(THIS_FILE, "Call %d: call transfered successfully, disconnecting call", call_id));
...
static void on_call_replaced(pjsua_call_id old_call_id,
	...
	PJ_LOG(3,
			(THIS_FILE, "Call %d with %.*s is being replaced by "
					"call %d with %.*s", old_call_id, (int) old_ci.remote_info.slen, old_ci.remote_info.ptr, new_call_id, (int) new_ci.remote_info.slen, new_ci.remote_info.ptr));
}
...
static void on_mwi_info(pjsua_acc_id acc_id, pjsua_mwi_info *mwi_info) {
	...
	if (mwi_info->rdata->msg_info.ctype) {
		...
		PJ_LOG(3,
				(THIS_FILE, " Content-Type: %.*s/%.*s", (int) ctype->media.type.slen, ctype->media.type.ptr, (int) ctype->media.subtype.slen, ctype->media.subtype.ptr));
	}
...
static void on_transport_state(pjsip_transport *tp, pjsip_transport_state state,
	...
	pj_ansi_snprintf(host_port, sizeof(host_port), "[%.*s:%d]",
			(int) tp->remote_name.host.slen, tp->remote_name.host.ptr,
			tp->remote_name.port);

	switch (state) {
	case PJSIP_TP_STATE_CONNECTED: {
		PJ_LOG(3,
				(THIS_FILE, "SIP %s transport is connected to %s", tp->type_name, host_port));
	}
		break;
...
static void on_ice_transport_error(int index, pj_ice_strans_op op,
	...
	PJ_UNUSED_ARG(param);
	PJ_PERROR(1,
			(THIS_FILE, status, "ICE keep alive failure for transport %d", index));
}
...
static pj_status_t on_snd_dev_operation(int operation) {
	PJ_LOG(3,
			(THIS_FILE, "Turning sound device %s", (operation ? "ON" : "OFF")));
	return PJ_SUCCESS;
}
...
static void on_call_media_event(pjsua_call_id call_id, unsigned med_idx,
	...
	PJ_LOG(5,
			(THIS_FILE, "Event %s", pjmedia_fourcc_name(event->type, event_name)));
...
static void change_online_status(void) {
	...
	struct opt {
		int id;
		char *name;
	} opts[] = { { AVAILABLE, "Available" }, { BUSY, "Busy" }, { OTP,
			"On the phone" }, { IDLE, "Idle" }, { AWAY, "Away" }, { BRB,
			"Be right back" }, { OFFLINE, "Offline" } };
	...
	if (status_code == PJSIP_SC_METHOD_NOT_ALLOWED) {
		...
		if (cap_hdr) {
			pjsip_msg_add_hdr(tdata->msg,
					pjsip_hdr_clone(tdata->pool, cap_hdr));
		}
	}
...
/* The module instance. */
static pjsip_module mod_default_handler = { NULL, NULL, /* prev, next.		*/
...
pj_status_t app_init(int argc, char *argv[]) {
	...
	app_config.pool = pjsua_pool_create("sip-app", 1000, 1000);
	...
	app_config.use_tls = 1;

	// set SRTP support
	app_config.cfg.use_srtp = 1;
	app_config.cfg.srtp_secure_signaling = 0;

	//Increase maximum number of calls
	...
	for (i = 0; i < app_config.tone_count; ++i) {
		...
		label = pj_str(name);
		status = pjmedia_tonegen_create2(app_config.pool, &label, 8000, 1, 160,
...
#else
		PJ_LOG(2,
				(THIS_FILE, "Warning: --play-avi is ignored because AVI is disabled"));
	...
	if (!app_config.no_udp) {
		...
		status = pjsua_transport_create(type, &app_config.udp_cfg,
				&transport_id);
		if (status != PJ_SUCCESS)
			goto on_error;
		...
		if (app_config.udp_cfg.port == 0) {
			...
			// v************ i have changed as 0 because sometime i got  pjsua_core.c  Error creating SIP TCP listener: Address already in use [status=120048]
			tcp_cfg.port = 0;
			//     printf("my sip tcp port %d",tcp_cfg.port);
		}
	}
	...
	if (app_config.use_tls) {
		...
		//  printf("my TLS port %d  transport_id %d",tcp_cfg.port,transport_id);
	...
	/* Set SPEEX codec to maximum priority as Manual*/
	//   pj_str_t speex_codec_id = pj_str((char *) "SPEEX/8000/1");
	//  pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_HIGHEST);
	/* Add RTP transports */
	if (app_config.ipv6)
...
/* Our Functionality Starts */

void mutethisPerson(int conf_slot, bool isMute) {
	...
	int totalCount = pjsua_call_get_count();

	pjsua_call_id call_ids[totalCount];
	unsigned call_cnt = PJ_ARRAY_SIZE(call_ids);
	unsigned i;

	//    NSLog(@"total no of calls %d",call_cnt);
	...
	for (i = 0; i < call_cnt; ++i) {
		...
		pjsua_conf_port_id pjsipConfAudioId = call_info.conf_slot;

		//        @try {
		if (pjsipConfAudioId != conf_slot) {

			pj_status_t status;
			if (isMute) {
				//                    NSLog(@"WC_SIPServer microphone disconnected from call");
				status = pjsua_conf_disconnect(conf_slot, pjsipConfAudioId);
			} else {
				status = pjsua_conf_connect(conf_slot, pjsipConfAudioId);
			}

			if (status != PJ_SUCCESS) {
				//                    DEBUGLog(@"warning:: Unable to mute/unmute for id %d  %d",call_ids[i],status);
			}
		} else {
			//                DEBUGLog(@"warning:: try to mute ");
		}
	}
...
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_createMuscPlayer(
		JNIEnv *env, jclass cls, jstring filepath) {
	const char *nativeString = (*env)->GetStringUTFChars(env, filepath, 0);

	pj_str_t wavefile1 = pj_str((char *) nativeString);

	pj_status_t status = pjsua_player_create(&wavefile1, 0, &player_id);

	if (status != PJ_SUCCESS) {
		__android_log_print(ANDROID_LOG_INFO, "calltest",
				"\n  *********failed to play*************** %d", status);

	} else {
		__android_log_print(ANDROID_LOG_INFO, "calltest",
				"\n  *********playing wav file*************** %d", status);
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    init
 * Signature: (Ljava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_init(JNIEnv *env,
		jclass cls, jstring proxy) {
	pj_status_t status = app_init(3, argv);
	if (status != PJ_SUCCESS) {
		//        [self showAlertWithString:[NSString stringWithFormat:@"Failed to initialize sip ---%d",status]];
	} else {
		//        app_running = true;
...
// * Signature: (Ljava/lang/String;)I
// */
//JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_init
//(JNIEnv *env, jclass cls, jstring proxy)
//{
//    pj_status_t status;
//
//    /* Create pjsua first! */
...
//        proxy_str = (char *) (*env)->GetStringUTFChars(env,proxy, &iscopy);
...
//
//        /*            comment for taking random port
//         cfg.port = 5060;  */
//        status = pjsua_transport_create(PJSIP_TRANSPORT_UDP, &cfg, &gTransId);
//        if (status != PJ_SUCCESS) {
////            LOGE("pjsua_transport_create errorrrrr");
//            return status;
//        }
//    }
//
...
//
//    /* Optionally disable some codec */
//    //         pj_str_t speex_codec_id = pj_str((char *) "PCMU/8000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, 255);
//
//
//    pjsua_codec_info c[32];
...
//        pj_str_t id;
//
//        strncpy(codec , c[i].codec_id.ptr, c[i].codec_id.slen);
//        codec[c[i].codec_id.slen] = 0;
//
//        //        __android_log_print(ANDROID_LOG_INFO,"droid123","Codec %s, prio %d", codec, c[i].priority );
//
//        //            pj_str_t id1 =
//
//        //            pjsua_codec_set_priority(c[i].codec_id.ptr,PJMEDIA_CODEC_PRIO_DISABLED);
//
//    }
//
//    //         speex_codec_id = pj_str((char *) "PCMU/8000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//    //
//    //         speex_codec_id = pj_str((char *) "iLBC/8000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//    //
//    //         speex_codec_id = pj_str((char *) "PCMA/8000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//    //
//    //         speex_codec_id = pj_str((char *) "GSM/8000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//    //
//    //         speex_codec_id = pj_str((char *) "SPEEX/8000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//    //
//    //         speex_codec_id = pj_str((char *) "SPEEX/16000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//    //
//    //         speex_codec_id = pj_str((char *) "SPEEX/32000/1");
//    //        pjsua_codec_set_priority(&speex_codec_id, PJMEDIA_CODEC_PRIO_DISABLED);
//
//
//
 ...
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_add_1account(
		JNIEnv *env, jclass cls, jstring sip_user, jstring sip_passwd,
		jstring sip_realm, jstring sip_registar, jstring proxy) {
	isAdd_reg = 1;

	int acc_id, ret;
	jboolean iscopy;
	char id[STR_SIZE], reg_uri[STR_SIZE];
	char *sip_user_ptr, *sip_realm_ptr, *sip_passwd_ptr, *sip_registar_ptr,
			*proxy_ptr;
	pj_status_t status;
	pjsua_acc_config cfg;

	sip_user_ptr = (char *) (*env)->GetStringUTFChars(env, sip_user, &iscopy);
	sip_passwd_ptr = (char *) (*env)->GetStringUTFChars(env, sip_passwd,
			&iscopy);
	sip_realm_ptr = (char *) (*env)->GetStringUTFChars(env, sip_realm, &iscopy);
	sip_registar_ptr = (char *) (*env)->GetStringUTFChars(env, sip_registar,
			&iscopy);
	proxy_ptr = (char *) (*env)->GetStringUTFChars(env, proxy, &iscopy);

	snprintf(id, STR_SIZE, "\"twoway\"<sip:%s@%s>", sip_user_ptr,
			sip_realm_ptr);
	snprintf(reg_uri, STR_SIZE, "sip:%s", sip_registar_ptr);

	pjsua_acc_config_default(&cfg);
	if (strlen(sip_user_ptr) != 0 && strlen(sip_realm_ptr) != 0
			&& strlen(sip_registar_ptr) != 0) {

		cfg.id = pj_str(id);
		cfg.reg_uri = pj_str(reg_uri);
		cfg.cred_count = 1;

		cfg.cred_info[0].realm = pj_str(sip_realm_ptr);
		...
		size_t forward_length = strlen(proxy_ptr);
		pj_str_t str = pj_str(proxy_ptr);
		if (forward_length != 0) {
			//            __android_log_print(ANDROID_LOG_INFO,"droid123","check my printf ######################### %d %s %d",strlen,str.ptr,str.slen);
			cfg.proxy[cfg.proxy_cnt++] = pj_str(proxy_ptr);
		}
	...
	if (status != PJ_SUCCESS) {
		...
		isAdd_reg = 0;
		//        LOGE("pjsua_acc_add errorrrrr");

		/* Negative return value indicates failure to Java */
		ret = -status;
	} else {
		//        LOGE("pjsua_acc_add success");
		ret = acc_id;
	}
...
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_closeTransport(
		JNIEnv *env, jclass cls, jint c_acc_id) {

	__android_log_print(ANDROID_LOG_INFO, "droid123",
			"\n came to closetransport..........");
	int the_acc_id = (int) c_acc_id;
	__android_log_print(ANDROID_LOG_INFO, "droid123",
			"\n came to closetransport..........%d", the_acc_id);

	pj_status_t status;
	if (the_trasport) {
		__android_log_print(ANDROID_LOG_INFO, "droid123",
				"\n inside the if condition..........");
		status = pjsip_transport_shutdown(the_trasport);
		pjsip_transport_dec_ref(the_trasport);
		the_trasport = NULL;
		__android_log_print(ANDROID_LOG_INFO, "droid123",
	...
	__android_log_print(ANDROID_LOG_INFO, "droid123", "\n end....");
	status = pjsua_acc_set_registration(the_acc_id, PJ_TRUE);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_acc_1get_1default(
 ...
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_make_1call(JNIEnv *env,
		jclass cls, jint acc_id, jstring url) {

	__android_log_print(ANDROID_LOG_INFO, "calltest",
			"\n ...............app config info............... %d",
			app_config.cfg.max_calls);
	__android_log_print(ANDROID_LOG_INFO, "calltest",
			"\n ...............max calls............... %d", PJSUA_MAX_CALLS);

	char *url_ptr;
	jboolean iscopy;
	pj_status_t status;

	url_ptr = (char *) (*env)->GetStringUTFChars(env, url, &iscopy);
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    makecallwithmode
 * Signature: (ILjava/lang/String;Ljava/lang/String;)I
 * Not used from Aug 06 2014
 */

JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_makecallwithmode(
		JNIEnv *env, jclass cls, jint acc_id, jstring url, jstring acc_uri) {
	__android_log_print(ANDROID_LOG_INFO, "calltest",
			"\n ...............app config info............... %d",
			app_config.cfg.max_calls);
	__android_log_print(ANDROID_LOG_INFO, "calltest",
	...
	pjsua_acc_get_config(current_acc, &acc_cfg);
	char *sip_user_ptr;
	sip_user_ptr = (char *) (*env)->GetStringUTFChars(env, acc_uri, &iscopy);
	acc_cfg.id = pj_str(sip_user_ptr);
	pj_status_t mod_tatus = pjsua_acc_modify(current_acc, &acc_cfg);
	...
	int callId;
	pj_str_t pj_url = pj_str(url_ptr);
	status = pjsua_call_make_call(current_acc, &pj_url, &call_opt, NULL,
			&msg_data, &callId);
	if (status != PJ_SUCCESS) {
		isAdd_reg = 0;
	}
...
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_modifyaccount(
		JNIEnv *env, jclass cls, jstring acc_uri) {
	__android_log_print(ANDROID_LOG_INFO, "calltest",
			"\n ...............app config info............... %d",
			app_config.cfg.max_calls);
	__android_log_print(ANDROID_LOG_INFO, "calltest",
 ...
 * Signature: (ILjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_answer_1call(
		JNIEnv *env, jclass cls, jint call_id) {
 ...
 * Signature: (ILjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_reject_1call(
		JNIEnv *env, jclass cls, jint call_id) {

	pj_status_t status;
	/*  486 busy here */
	status = pjsua_call_answer(call_id, 486, NULL, NULL);
	if (status != PJ_SUCCESS) {
 ...
 * Signature: (ILjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_hangup_1call(
		JNIEnv *env, jclass cls, jint call_id) {
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_hold_1call(JNIEnv *env,
		jclass cls, jint callid) {
	__android_log_print(ANDROID_LOG_INFO, "droid123", "\n hold_call----> ");
	...
	if (callid != -1) {
		...
		//                    printf("*********set hold success");
		__android_log_print(ANDROID_LOG_INFO, "droid123",
				"\n count----> *********set hold   success");
		int totalCount = pjsua_call_get_count();
		if (totalCount != 0) {
			pjsua_call_id call_ids[totalCount];
			unsigned call_cnt = PJ_ARRAY_SIZE(call_ids);
			unsigned i;
			__android_log_print(ANDROID_LOG_INFO, "droid123",
					"\n  total call count----> %d", call_cnt);
			pjsua_enum_calls(call_ids, &call_cnt);
			pjsua_call_info thisPerson_call_info;
			pjsua_call_get_info(callid, &thisPerson_call_info);
			pjsua_conf_port_id conf_slot = thisPerson_call_info.conf_slot;
			status = pjsua_conf_adjust_rx_level(conf_slot, 0);
			status = pjsua_conf_disconnect(0, conf_slot);
			// connect to player
			...
			for (i = 0; i < call_cnt; ++i) {
				...
				pjsua_call_get_info(call_ids[i], &call_info);
				pjsua_conf_port_id pjsipConfAudioId = call_info.conf_slot;
				if (pjsipConfAudioId != conf_slot && pjsipConfAudioId > 0) {
					status = pjsua_conf_disconnect(conf_slot, pjsipConfAudioId);
					status = pjsua_conf_disconnect(pjsipConfAudioId, conf_slot);
	...
	{
		/*                pjsua_perror(THIS_FILE, "Error to hold call", status); */
		printf("*********set hold Not   success");

		__android_log_print(ANDROID_LOG_INFO, "droid123",
				"\n count----> *********set hold Not   success");
		return 0;
	}
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_unhold_1call(
		JNIEnv *env, jclass cls, jint callid, jint swap_callid) {
	...
	if (callid != -1) {
		...
		if (totalCount != 0) {
			...
			status = pjsua_conf_disconnect(
					pjsua_player_get_conf_port(player_id), conf_slot);
			status = pjsua_conf_connect(0, conf_slot);
			status = pjsua_conf_adjust_rx_level(conf_slot, 1.0);
			...
			for (i = 0; i < call_cnt; ++i) {
				...
				pjsua_conf_port_id pjsipConfAudioId = call_info.conf_slot;
				if (pjsipConfAudioId != conf_slot && pjsipConfAudioId > 0) {
					if (swap_callid != call_ids[i]) {
						status = pjsua_conf_connect(conf_slot,
								pjsipConfAudioId);
						status = pjsua_conf_connect(pjsipConfAudioId,
								conf_slot);
					}
				}
			}
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_hangupall
(JNIEnv *env, jclass cls) {
	pjsua_call_hangup_all();
}
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    delete_account_id
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_delete_1accId(
		JNIEnv *env, jclass cls, jint acc_id) {

	pj_bool_t status;

	if (!pjsua_acc_is_valid(acc_id)) {
		//        __android_log_print(ANDROID_LOG_INFO,"droid123","Invalid account id %d\n", acc_id);
		return 0;
	} else {

		status = pjsua_acc_del(acc_id);

		//        __android_log_print(ANDROID_LOG_INFO,"droid123","Account %d deleted\n", acc_id);
	}
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_Reregister
(JNIEnv *env, jclass cls, jint acc_id)
{
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_Unregister
(JNIEnv *env, jclass cls, jint acc_id)
{
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_MuteMic(JNIEnv *env,
		jclass cls, jint callid) {
	pjsua_call_info ci;
	...
	if (pjsipConfAudioId != 0) {
		pj_status_t status = pjsua_conf_adjust_rx_level(pjsipConfAudioId, 0);

		mutethisPerson(pjsipConfAudioId, true);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_UnMuteMic(JNIEnv *env,
		jclass cls, jint callid) {
	pjsua_call_info ci;
	...
	if (pjsipConfAudioId != 0) {
		...
		pj_status_t status = pjsua_conf_adjust_rx_level(pjsipConfAudioId, 1.0);
		mutethisPerson(pjsipConfAudioId, true);
		if (status == PJ_SUCCESS) {
			return 1;
		} else {
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    muteMicReceiver
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_com_base_android_pjsua_pjsua_MuteMicReceiver(
		JNIEnv *env, jclass cls, jint callid) {
	pjsua_call_info ci;
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    unmuteMicReceiver
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_com_base_android_pjsua_pjsua_UnMuteMicReceiver(
		JNIEnv *env, jclass cls, jint callid) {
	pjsua_call_info ci;
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    toggleDeviceMicMute
 * Signature: (Z)V
 */

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_SwapLines
(JNIEnv *env, jclass cls, jint callid,jint toggle,jint devicemicmuteon,jint swap_id,jint needtodisconnect)
{
	pjsua_call_info ci;
	...
	pjsua_call_info s_ci;

	pjsua_call_get_info(swap_id, &s_ci);
	pjsua_conf_port_id s_pjsipConfAudioId = s_ci.conf_slot;

	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to saplines ----- call_id.. %d",callid);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to saplines ----- toggle.. %d",toggle);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to saplines ----- audio slat.. %d",pjsipConfAudioId);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to saplines ----- device mic mute.. %d",devicemicmuteon);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to swaplines ----- swape slot id.. %d",s_pjsipConfAudioId);

	if(toggle==0)
	{
		if( pjsipConfAudioId != -1 ) {

			__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to saplines connect media");

			pjsua_conf_connect(0, pjsipConfAudioId);
			pjsua_conf_connect(pjsipConfAudioId,0);
		}
		if(devicemicmuteon==1)
		{
			pjsua_conf_disconnect(0,pjsipConfAudioId); // mic
		}
	}
	else
	{
		if( pjsipConfAudioId != -1 ) {
			__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to swapline disconnect");
			pjsua_conf_disconnect(0, pjsipConfAudioId);
			pjsua_conf_disconnect(pjsipConfAudioId, 0);

			if(needtodisconnect==1)
			{
				if(s_pjsipConfAudioId!=-1)
				{
					pjsua_conf_disconnect(pjsipConfAudioId, s_pjsipConfAudioId);
					pjsua_conf_disconnect(s_pjsipConfAudioId, pjsipConfAudioId);
				}
			}
...
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_SwapIndividualLine
(JNIEnv *env, jclass cls, jint callid,jint swap_id)
{
	pjsua_call_info ci;
	...
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to swapsingleline---- call_slat= %d",pjsipConfAudioId);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to swapsingleline---- swap_slot= %d",s_pjsipConfAudioId);
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_toggleDeviceMicMute
(JNIEnv *env, jclass cls, jboolean isMute)
{

	//    isDeviceMicMuteOn=isMute;
	...
	if (totalCount!=0) {
		...
		for (i=0; i<call_cnt; ++i) {
			...
			pjsua_call_info call_info;
			pjsua_call_get_info(call_ids[i], &call_info);
			//            printf("on call stae id %d  username %s  conf_slot %d media %d",call_ids[i],call_info.remote_info.ptr,call_info.conf_slot,call_info.media[i].stream.aud.conf_slot);

			if (!pjsua_call_has_media(call_ids[i]))

			continue;

			//            printf("user %s has media",call_info.remote_info.ptr);
			...
			if( pjsipConfAudioId != 0 )
			{
				...
				if (isMute) {
					//                        NSLog(@"WC_SIPServer microphone disconnected from call");
					status= pjsua_conf_disconnect(0, pjsipConfAudioId);
				}
				else {
					status= pjsua_conf_connect(0, pjsipConfAudioId);
				}
			...
			{
				//                    DEBUGLog(@"warning:: at mute/unmute call conf id 0");
			}
			//            }
			//            @catch (NSException *exception) {
			//                NSLog(@"Unable to mute microphone: %@", exception);
 ...
 * Signature: (V)Z
 */
JNIEXPORT jboolean JNICALL Java_com_base_android_pjsua_pjsua_holdSession(
		JNIEnv *env, jclass cls, jint swap_call_id) {
	int totalCount = pjsua_call_get_count();
	if (totalCount != 0) {
		...
		for (i = 0; i < call_cnt; ++i) {
			...
			if (pjsipConfAudioId > 0) {
				...
				if (swap_call_id != call_ids[i]) {
					status = pjsua_conf_adjust_rx_level(pjsipConfAudioId, 0);
					status = pjsua_conf_disconnect(pjsipConfAudioId, 0);
					status = pjsua_conf_disconnect(0, pjsipConfAudioId);
					status = pjsua_conf_connect(
							pjsua_player_get_conf_port(player_id),
							pjsipConfAudioId);
				}
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    unHoldSession
 * Signature: (V)Z
 */
JNIEXPORT jboolean JNICALL Java_com_base_android_pjsua_pjsua_unHoldSession(
		JNIEnv *env, jclass cls, jint swap_call_id) {
			...
			if (pjsipConfAudioId > 0) {
				...
				if (swap_call_id != call_ids[i]) {
					status = pjsua_conf_disconnect(
							pjsua_player_get_conf_port(player_id),
							pjsipConfAudioId);
					status = pjsua_conf_adjust_rx_level(pjsipConfAudioId, 1.0);
					status = pjsua_conf_connect(0, pjsipConfAudioId);
					status = pjsua_conf_connect(pjsipConfAudioId, 0);
				}
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    callTobroadcastMode
 * Signature: (V)Z
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_callTobroadcastMode
(JNIEnv *env, jclass cls, jboolean isBroadcastmode)
{
	...
	if (totalCount!=0) {
		...
		//        NSLog(@"broadcast::total no of calls %d",call_cnt);
		...
		for (i=0; i<call_cnt; ++i)
		{
			...
			if (call_ids[i] != -1 && ci.state == PJSIP_INV_STATE_CONFIRMED) {
				...
				if( pjsipConfAudioId != 0 ) {
					...
					if (status!=PJ_SUCCESS) {
						pjsua_perror("sipclient wrapper", "broadcast::", status);

					}
					mutethisPerson(pjsipConfAudioId,isBroadcastmode);
					//                        [self mutethisPerson:(int)pjsipConfAudioId isMute:isBroadcastmode];
				}

			}
			//            }
			//            @catch (NSException *exception) {
			//                NSLog(@"broadcast:: %@", exception);
			//            }
		}
...
/*
 * Class:     com_base_android_pjsua_pjsua
 * Method:    checkBroadcastMode
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_checkBroadcastMode
(JNIEnv *env, jclass cls, jint call_id)
{
	//    if (isDeviceBroadCastModeOn) {
	pjsua_call_info ci;
	...
	if( pjsipConfAudioId != 0 ) {
		...
		mutethisPerson(pjsipConfAudioId,true);
		//                [self mutethisPerson:(int)pjsipConfAudioId isMute:isDeviceBroadCastModeOn];
	}
	//        }
	//        @catch (NSException *exception) {
	//            NSLog(@"broadcast:: %@", exception);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_ToggleSpeaker(
		JNIEnv *env, jclass cls, jint isSpeakerOn) {
	...
	if (status == PJ_SUCCESS) {
		...
		//        __android_log_print(ANDROID_LOG_INFO,"droid123","Toggle Speaker Failure 1 %d",status);
		return 0;
	}
}
 ...
 * Signature: ([I)V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_setpriority
(JNIEnv *env, jclass cls,jintArray array) {
	...
	for(i=0;i<len;i++)
	{
		//__android_log_print(ANDROID_LOG_INFO,"droid123","codec name",array[i]);
		if(body[i]==1)
		{
			pj_str_t speex_codec_id = pj_str((char *) "SPEEX/8000/1");
			pjsua_codec_set_priority(&speex_codec_id, 255-i);
		}
		else if(body[i]==2)
		{
			pj_str_t speex_codec_id = pj_str((char *) "SPEEX/16000/1");
			pjsua_codec_set_priority(&speex_codec_id, 255-i);
		}
		else if(body[i]==3)
		{
			pj_str_t speex_codec_id = pj_str((char *) "SPEEX/32000/1");
			pjsua_codec_set_priority(&speex_codec_id, 255-i);
		}
		else if(body[i]==4)
		{
			pj_str_t speex_codec_id = pj_str((char *) "iLBC/8000/1");
			pjsua_codec_set_priority(&speex_codec_id, 255-i);
		}
		else if(body[i]==5)
		{
			pj_str_t speex_codec_id = pj_str((char *) "GSM/8000/1");
			pjsua_codec_set_priority(&speex_codec_id, 255-i);
		}
		else if(body[i]==6)
		{
		...
		{
			pj_str_t speex_codec_id = pj_str((char *) "PCMA/8000/1");
			pjsua_codec_set_priority(&speex_codec_id, 255-i);
		}

	}

//(*env)->ReleaseIntArrayElements(env, body, array,JNI_ABORT);
 ...
 * Method:    enablesrtp
 * Signature: (I,I)V
 *if flag=0 ->disable SRTP
 *if flag=1 ->SRTP is optional
 *if flag=2 ->SRTP is Mandatory
 *if flag=3 ->Optional by duplicate media
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_enablesrtp
(JNIEnv *env, jclass cls,jint acc_id,jint flag,jint secure_signalling) {

	pjsua_acc_config acc_cfg;
	pjsua_acc_get_config(current_acc,&acc_cfg);

	if (acc_cfg.use_srtp != flag) {

		acc_cfg.use_srtp=flag;
		acc_cfg.srtp_secure_signaling=secure_signalling;
		pj_status_t mod_tatus= pjsua_acc_modify(current_acc, &acc_cfg);

	}
}

JNIEXPORT jintArray JNICALL Java_com_base_android_pjsua_pjsua_setFiletoUnicastRecord(
		JNIEnv *env, jclass cls, jstring flename, jint len, jint recid) {

	int length = (int) len;

	int rec_id = (int) recid;
	...
	__android_log_print(ANDROID_LOG_INFO, "droid123",
			"\n came to setfile for unicast recording rec_id..........%d",
			rec_id);

	int rec_port;

	jboolean iscopy;
	char *file_ptr = (char *) (*env)->GetStringUTFChars(env, flename, &iscopy);
	const pj_str_t filepath = pj_str(file_ptr);

	if (length) {
		pjsua_recorder_create(&filepath, 0, NULL, 0, 0, &rec_id);

		rec_port = pjsua_recorder_get_conf_port(rec_id);

		__android_log_print(ANDROID_LOG_INFO, "droid123",
				"\n came to setfile for uncast after initialize.........%d",
				rec_id);

	}
	int mydetails[2] = { rec_id, rec_port };

	(*env)->SetIntArrayRegion(env, result, 0, 2, mydetails);

	(*env)->ReleaseStringUTFChars(env, flename, file_ptr);

	return result;
}

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_startUnicastRecording
(JNIEnv *env, jclass cls,jint cid,jint recPort) {

	int callid=(int)cid;

	int rec_port=(int)recPort;

	if (rec_port!= PJSUA_INVALID_ID) {

		pjsua_conf_connect(pjsua_call_get_conf_port(callid),
				rec_port);

	}
}

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_stopUnicastRecording
(JNIEnv *env, jclass cls,jint recPort) {

	int rec_port=(int)recPort;

	pjsua_recorder_destroy(rec_port);

}

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_setfiletorecord
(JNIEnv *env, jclass cls,jstring flename,jint len) {

	const char *filename = (*env)->GetStringUTFChars(env, flename, 0);

	int length=(int)len;

	app_config.auto_rec=PJ_TRUE;

	app_config.rec_file.ptr=(char*)realloc(NULL,length);

	strcpy(app_config.rec_file.ptr,filename);

	app_config.rec_file.slen=length;

	if (app_config.rec_file.slen) {
		pjsua_recorder_create(&app_config.rec_file, 0, NULL, 0, 0,
				&app_config.rec_id);

		app_config.rec_port = pjsua_recorder_get_conf_port(app_config.rec_id);

	}
	(*env)->ReleaseStringUTFChars(env, flename, filename);
}

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_startrecording
(JNIEnv *env, jclass cls,jint cid) {
...
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_stoprecording
(JNIEnv *env, jclass cls) {
...
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_sendmessagetoreferBuddy
(JNIEnv *env, jclass cls,jstring response,jstring remote_info) {

	const char *nativeString = (*env)->GetStringUTFChars(env, response, 0);
	const char *r_info = (*env)->GetStringUTFChars(env, remote_info, 0);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to send message torefer buddy message is..........%s",nativeString);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to send message torefer buddy remote info is..........%s",r_info);

	pj_str_t tmp=pj_str((char*)nativeString);
	pj_str_t dest_uri = pj_str((char*)r_info);

	pjsua_im_send(current_acc, &dest_uri,NULL, &tmp, NULL, NULL);

	(*env)->ReleaseStringUTFChars(env, response, nativeString);
	(*env)->ReleaseStringUTFChars(env, response, r_info);
}

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_sendresponsemessage
(JNIEnv *env, jclass cls,jstring response,jint call_id) {

	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to send message..........");
	const char *nativeString = (*env)->GetStringUTFChars(env, response, 0);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to send message.. %s",nativeString);

	pj_str_t tmp=pj_str((char*)nativeString);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n xml send message... %s",tmp);
	int totalCount = pjsua_call_get_count();
	if (totalCount!=0) {
		...
		if (call_id!= -1 && call_info.state == PJSIP_INV_STATE_CONFIRMED) {

			if( pjsipConfAudioId != -1 ) {

				pj_str_t dest_uri = pj_str(call_info.remote_info.ptr);

				pjsua_im_send(current_acc, &dest_uri,NULL, &tmp, NULL, NULL);

				__android_log_print(ANDROID_LOG_INFO, "droid123","\n after sending message %s",dest_uri.ptr);
...
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_sendmessage
(JNIEnv *env, jclass cls,jstring xml) {

	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to send message..........");

	const char *nativeString = (*env)->GetStringUTFChars(env, xml, 0);
	__android_log_print(ANDROID_LOG_INFO, "droid123","\n came to send message.. %s",nativeString);
	...
	if (totalCount!=0) {
		...
		for (i=0; i<call_cnt; i++) {
			...
			__android_log_print(ANDROID_LOG_INFO, "droid123","\n xml send message call id... %d",call_ids[i]);

			if (call_ids[i] != -1 && call_info.state == PJSIP_INV_STATE_CONFIRMED) {

				if( pjsipConfAudioId != -1 ) {

					pj_str_t dest_uri = pj_str(call_info.remote_info.ptr);

					pjsua_im_send(call_info.acc_id, &dest_uri,NULL, &tmp, NULL, NULL);
	...
	(*env)->ReleaseStringUTFChars(env, xml, nativeString);
}

JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_setwhispermodeforcallid
(JNIEnv *env, jclass cls,jint call_id,jint flag) {

	int callid=(int)call_id;
	int mod_flag=(int)flag;

	pjsua_call_info wish_user__call_info;
	pjsua_call_get_info(callid, &wish_user__call_info);

	pjsua_conf_port_id wish_user_conf_slot = wish_user__call_info.conf_slot;

	if(wish_user_conf_slot >0)
	{
		...
		if (totalCount!=0) {
			...
			for (i=0; i<call_cnt; ++i) {
				...
				if (callid !=call_ids[i]) {
					int this_call_id;
					this_call_id=call_ids[i];
					pjsua_call_info this_call_info;

					pjsua_call_get_info(this_call_id, &this_call_info);
					pjsua_conf_port_id this_conf_slot = this_call_info.conf_slot;

					if (mod_flag==1) {
						// disconnect my mic from all users other than wishper buddy

						pjsua_conf_disconnect(0,this_conf_slot);

						// disconnect their mic to me
						pjsua_conf_disconnect(this_conf_slot,0);

						// disconnect wishper mode buddy  mic from all users other than myself

						pjsua_conf_disconnect(wish_user_conf_slot, this_conf_slot);

						pjsua_conf_disconnect(this_conf_slot, wish_user_conf_slot);
					...
					else
					{
						...
						pjsua_conf_connect(0,this_conf_slot);

						// disconnect their mic to me
						pjsua_conf_connect(this_conf_slot,0);

						// disconnect wishper mode buddy  mic from all users other than myself

						pjsua_conf_connect(wish_user_conf_slot, this_conf_slot);

						pjsua_conf_connect(this_conf_slot, wish_user_conf_slot);
...
void transfer_call(int transfer_call_id, pj_str_t dest_uri) {
	...
	if (current_call == -1) {
		...
		pjsua_call_info ci;
		pjsua_call_get_info(transfer_call_id, &ci);
//		ui_input_url("Transfer to URL", buf, sizeof(buf), &result);
		...
		pjsua_call_xfer(transfer_call_id, &dest_uri, NULL);
	}
}

JNIEXPORT jint JNICALL Java_com_base_android_pjsua_pjsua_bridgemycall(
		JNIEnv *env, jclass cls, jint callid) {

	pjsua_call_info dest_call_info;
	pjsua_call_get_info(callid, &dest_call_info);

	pj_str_t dest_uri = dest_call_info.remote_info;

	pj_status_t status;

	status = pjsua_call_answer(callid, 200, NULL, NULL);

	//            pj_str_t dest_uri=pj_str((char *)[@"sip:951024@10.100.140.70" UTF8String]);
	...
	if (totalCount != 0) {
		...
		for (i = 0; i < call_cnt; ++i) {
			...
			if (callid != call_ids[i]) {
				...
				transfer_call(call_ids[i], dest_uri);
...
JNIEXPORT jboolean JNICALL Java_com_base_android_pjsua_pjsua_checkMediaAlive(
		JNIEnv *env, jclass cls, jint call_id) {
	pjsua_call_info call_info;
	pjsua_call_get_info(call_id, &call_info);
	pjsua_conf_port_id pjsipConfAudioId = call_info.conf_slot;
	if (pjsipConfAudioId != 0) {
		unsigned tx_level = 0;
		unsigned rx_level = 0;
		pj_status_t checkstatus = pjsua_conf_get_signal_level(pjsipConfAudioId,
				&tx_level, &rx_level);
		if (checkstatus != PJ_SUCCESS)
			__android_log_print(ANDROID_LOG_INFO, "droid123",
					"\n getting signal status having error");

		__android_log_print(ANDROID_LOG_INFO, "droid123", "\n user name---- %s",
				call_info.remote_info.ptr);

		__android_log_print(ANDROID_LOG_INFO, "droid123",
				"\n received media level---- %d", rx_level);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_base_android_pjsua_pjsua_destroy
(JNIEnv *env, jclass cls) {
	pjsua_destroy();
}
static JNINativeMethod gMethods[] =
		{ { "init", "(Ljava/lang/String;)I",
				(void *) Java_com_base_android_pjsua_pjsua_init }, {
				"createMusicPlayer", "(Ljava/lang/String;)I",
				Java_com_base_android_pjsua_pjsua_createMuscPlayer },
				{ "add_account",
						"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I",
						(void *) Java_com_base_android_pjsua_pjsua_add_1account },
				{ "acc_get_default", "()I",
						(void *) Java_com_base_android_pjsua_pjsua_acc_1get_1default },
				{ "make_call", "(ILjava/lang/String;)I",
						(void *) Java_com_base_android_pjsua_pjsua_make_1call },
				{ "makecallwithmode",
						"(ILjava/lang/String;Ljava/lang/String;)I",
						(void *) Java_com_base_android_pjsua_pjsua_makecallwithmode },
				{ " modifyaccount", "(Ljava/lang/String;)I",
						(void *) Java_com_base_android_pjsua_pjsua_modifyaccount },
				{ "answer_call", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_answer_1call },
				{ "reject_call", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_reject_1call },
				{ "hold_call", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_hold_1call },
				{ "hold_call", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_hold_1call },
				{ "unhold_call", "(II)I",
						(void *) Java_com_base_android_pjsua_pjsua_unhold_1call },
				{ "delete_accId", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_delete_1accId },
				{ "MuteMic", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_MuteMic }, {
						"UnMuteMic", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_UnMuteMic },
				{ "MuteMicReceiver", "(I)Z",
						(void *) Java_com_base_android_pjsua_pjsua_MuteMicReceiver },
				{ "UnMuteMicReceiver", "(I)Z",
						(void *) Java_com_base_android_pjsua_pjsua_UnMuteMicReceiver },
				{ "toggleDeviceMicMute", "(Z)V",
						(void *) Java_com_base_android_pjsua_pjsua_toggleDeviceMicMute },
				{ "holdSession", "(I)Z",
						(void *) Java_com_base_android_pjsua_pjsua_holdSession },
				{ "unHoldSession", "(I)Z",
						(void *) Java_com_base_android_pjsua_pjsua_unHoldSession },
				{ "callTobroadcastMode", "(Z)V",
						(void *) Java_com_base_android_pjsua_pjsua_callTobroadcastMode },
				{ "checkBroadcastMode", "(I)V",
						(void *) Java_com_base_android_pjsua_pjsua_checkBroadcastMode },
				{ "Reregister", "(I)V",
						(void *) Java_com_base_android_pjsua_pjsua_Reregister },
				{ "Unregister", "(I)V",
						(void *) Java_com_base_android_pjsua_pjsua_Unregister },
				{ "ToggleSpeaker", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_ToggleSpeaker },
				{ "hangupall", "()V",
						(void *) Java_com_base_android_pjsua_pjsua_hangupall }, {
						"setpriority", "([I)V",
						(void *) Java_com_base_android_pjsua_pjsua_setpriority },
				{ "bridge", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_bridgemycall },
				{ "swap", "(III)V",
						(void *) Java_com_base_android_pjsua_pjsua_SwapLines },
				{ "sendresponse", "(Ijava/lang/String;)V",
						(void *) Java_com_base_android_pjsua_pjsua_sendresponsemessage },
				{ "sendresponse to refer buddy",
						"(java/lang/String;java/lang/String;)V",
						(void *) Java_com_base_android_pjsua_pjsua_sendmessagetoreferBuddy },
				{ "swapsinglelinr", "(II)V",
						(void *) Java_com_base_android_pjsua_pjsua_SwapIndividualLine },
				{ "Shutdowntransport", "(I)I",
						(void *) Java_com_base_android_pjsua_pjsua_closeTransport },
				{ "destroy", "()V",
						(void *) Java_com_base_android_pjsua_pjsua_destroy } };

/* Calls While Load Lib in java*/
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
	...
	/*        <Class instance caching> /
	 ...
	 /*        <Native function registration>  we write it as static*/

	jobject *objptr = &gInterfaceObject;
	...
	for (i = 0; i < app_config.cfg.max_calls; ++i) {
		...
		for (j = 0; j < MAX_RETRY; ++j) {
			...
			pj_sockaddr_init(pj_AF_INET6(), &si.rtp_addr_name,
					&app_config.rtp_cfg.public_addr, (unsigned short) (port));
